...
/******************************************
 * dm3730_evk_identify
 * Description: Detect if we are running on a DM3730_EVK revision Ax/Bx,
...
int dm3730_evk_revision(void)
{
	...
	return rev;
#else
	return REVISION_XM/*REVISION_CX*/;
#endif
}
...
void config_3430sdram_ddr(void)
{
	...
	if (dm3730_evk_revision() == REVISION_XM) {
#ifdef CONFIG_DDR_512MB
...
int misc_init_r(void)
{
	...
	rev = dm3730_evk_revision();
	switch (rev) {
	case REVISION_AXBX:
		printf("DM3730_EVK Rev Ax/Bx\n");
		break;
	case REVISION_CX:
		printf("DM3730_EVK Rev C1/C2/C3\n");
		break;
	case REVISION_C4:
		printf("DM3730_EVK Rev C4\n");
		break;
	case REVISION_XM:
		printf("DM3730_EVK xM Rev A\n");
		break;
	default:
		printf("DM3730_EVK unknown 0x%02x\n", rev);
	}
