...
omap3devkit8500_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3devkit8500

dm3730_evk_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 dm3730_evk

omap3sbc8510_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3sbc8510

omap3sbc8100_plus_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3sbc8100_plus

omap3sbc8150_config :    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3sbc8150

omap3sbc8530_config :   unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3sbc8530

omap3soc8600_config :	unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3soc8600
#########################################################################
